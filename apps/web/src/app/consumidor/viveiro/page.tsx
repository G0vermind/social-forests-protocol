...
export default function ConsumidorDashboard() {
  ...
  // Dados mockados para simular o estado inicial do consumidor
  const mockState = {
    folhas: 1450,
    arvores: 2,
    co2: 450, // kg
    nivel: 'Explorador',
    progressoProximaArvore: 65, // %
    missoesCompletadas: 12,
  };
      ...
      <div className="max-w-6xl mx-auto space-y-6 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          <div className="bg-gradient-to-br from-emerald-900/40 to-slate-900 border border-emerald-500/20 rounded-3xl p-6 relative overflow-hidden group hover:border-emerald-500/40 transition-all">
            ...
            <div className="relative z-10">
              ...
              <div className="flex items-baseline gap-2">
                <span className="text-4xl font-extrabold text-white">{mockState.folhas.toLocaleString()}</span>
          ...
          <div className="bg-gradient-to-br from-blue-900/40 to-slate-900 border border-blue-500/20 rounded-3xl p-6 relative overflow-hidden group hover:border-blue-500/40 transition-all">
            ...
            <div className="relative z-10">
              <h2 className="text-sm font-semibold text-slate-400 uppercase tracking-wider mb-1">CO₂ Sequestrado</h2>
              <div className="flex items-baseline gap-2">
                <span className="text-4xl font-extrabold text-white">{mockState.co2}</span>
            ...
            <div className="relative z-10">
              <div className="flex justify-between items-end mb-2">
                <div>
                  ...
                  <div className="flex items-baseline gap-2">
                    <span className="text-4xl font-extrabold text-white">{mockState.arvores}</span>
              ...
              <div className="mt-4">
                <div className="flex justify-between text-xs text-slate-400 mb-1.5">
                  ...
                  <span className="text-purple-300 font-medium">{mockState.progressoProximaArvore}%</span>
                </div>
                <div className="h-1.5 w-full bg-slate-800 rounded-full overflow-hidden">
                  <div 
                    className="h-full bg-gradient-to-r from-purple-500 to-pink-500 rounded-full transition-all duration-1000 ease-out"
                    style={{ width: `${mockState.progressoProximaArvore}%` }}
                  />
                </div>
              </div>
            </div>
          ...
          <div className="lg:col-span-2 space-y-4">
            <div className="flex items-center justify-between">
              <h2 className="text-xl font-bold text-white flex items-center gap-2">
                Sua Coleção <span className="text-slate-500 text-sm font-normal">({mockState.arvores} ativos)</span>
              </h2>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              <div className="bg-slate-900/30 border border-dashed border-slate-700 rounded-3xl p-5 flex flex-col items-center justify-center text-center hover:bg-slate-900/50 transition-colors group cursor-pointer">
                ...
                <p className="text-xs text-slate-600 mt-1">Acumule mais 350 folhas para forjar.</p>
              </div>
            </div>
          </div>
